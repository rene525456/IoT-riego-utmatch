...
*/
// WiFi
char* ssid = "Internet_UNL";        // Nombre de la red del sembrio
const char* wifi_password = "UNL1859WiFi";  // COntraseña de la red
...
const char* mqtt_server = "10.20.138.8";  // Direccion Ip del Broker o Raspberry Pi
//const char* temperature_topic = "home/sembrio1/temperature";
// tipic para configurar 
const char* humedytySolid_topic = "suelo1";
const char* humedytySolid_topic1 = "suelo2";
const char* humedytySolid_topic2 = "suelo3";
const char* mqtt_username = "reneriego"; // Nombre del Usuario del MQTT configurado en el broker
const char* mqtt_password = "rene5254"; // Nombre del Contraseña del MQTT configurado en el broker
...
void loop() {
  ...
  if (millis() - env_msg_delay > TIME_DELAY) {
    /**
       da los datos del sensor, maximo valor 4095, minimo 100
    */
    //SENSOR 1
    ...
    */
    ...
    // envian datos a los suscriptores
